    ...
    extend: {
      ...
      colors: {
        ...
        obsidian: {
          ...
          light: "hsl(var(--obsidian-light) / <alpha-value>)",
        },
      },
      fontFamily: {
        sans: ["var(--font-sans)"],
      ...
      backgroundImage: {
        ...
        'obsidian-gradient': 'linear-gradient(180deg, hsl(222 47% 5%) 0%, hsl(222 47% 3%) 100%)',
      },
      boxShadow: {
        ...
        '3d': '0 20px 40px -15px rgba(0, 0, 0, 0.3), 0 10px 20px -10px rgba(0, 0, 0, 0.2)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
